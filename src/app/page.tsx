          ...
          <div className="container hero-inner">
            <div className="hero-copy">
              ...
              <p className="preview-notice">
                <strong>초기 개발 버전</strong> — 중요한 바탕화면 구성에서는
                별도의 Windows 사용자 환경에서 먼저 시험해 주세요.
              </p>
            </div>
            <figure>
              <Image
        ...
        >
          <div className="container editions-inner">
            ...
            <p className="trial-note">
              Pro 평가가 끝나면 Free로 전환되며, 기존 박스와 파일은 그대로
              유지됩니다.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="feature-grid">
              <FeatureCard
                number="01"
                title="박스 단위로 정리"
                description="파일, 폴더와 바로가기를 목적에 맞는 여러 박스로 나누어 한눈에 찾을 수 있습니다."
              />
              <FeatureCard
                number="02"
                title="내 방식대로 배치"
                description="박스를 이동하거나 크기를 조절하고, 접기와 잠금으로 필요한 공간만 남길 수 있습니다."
              />
              <FeatureCard
                number="03"
                title="화면 구성별 복원"
                description="모니터 구성에 맞춰 박스의 위치와 크기를 기억해 익숙한 작업 환경을 유지합니다."
              />
              <FeatureCard
                number="04"
                title="사진 뷰어"
                description="박스 안의 사진과 폴더 속 이미지를 슬라이드쇼로 감상하고 전환 간격과 순서를 설정할 수 있습니다."
              />
            </div>
          </div>
        </section>
