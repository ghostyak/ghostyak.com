...
export const homeSlides: readonly HeroSlide[] = [
  {
    ...
    description:
      "흩어진 파일과 바로가기를 목적에 맞는 박스에 모아 한눈에 정리하세요.",
    actionLabel: "제품 둘러보기",
  ...
  },
  {
    ...
    description:
      "업무, 프로젝트, 자주 쓰는 도구를 나만의 방식으로 나누고 바로 꺼내 쓸 수 있습니다.",
    actionLabel: "제품 둘러보기",
    actionHref: "/product/boxes",
  ...
  features: [
    {
      title: "박스로 한눈에 정리",
      description:
        "관련된 파일, 폴더와 바로가기를 목적별 박스에 모아 필요한 항목을 빠르게 찾습니다.",
    },
    {
      title: "내 작업 방식에 맞게",
      description:
        "박스의 위치와 크기를 자유롭게 조절하고 필요할 때 접어 바탕화면 공간을 확보합니다.",
    },
    {
      title: "원본 파일은 그대로",
      description:
        "원본 위치를 바꾸지 않고 바로가기로 정리하므로 기존 폴더 구조를 안전하게 유지합니다.",
    },
  ],
} as const;
