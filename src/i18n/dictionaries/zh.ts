...
const zh: Dictionary = {
  ...
  home: {
    ...
    products: { eyebrow: "GHOSTYAK SOFTWARE", heading: "现已推出的产品", intro: "我们不追求复杂功能，而是专注解决每天遇到的小麻烦。", freeBadge: "免费", viewAction: "查看产品", webBadge: "网页", clockDescription: "一款免费的在线时间工具，集当前时间、闹钟、计时器、番茄钟、秒表和世界时钟于一处。", osintsDescription: "在一处使用多个 OSINT 网站，搜索和分析 IP 地址、域名等信息的工具。", webAction: "打开网站", clockPreviewLabel: "Ghostyak Clock 预览" },
